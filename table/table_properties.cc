...
std::string TableProperties::ToString(
  ...
  AppendProperty(result, "Encryption type",
      encryption_name.empty() ? std::string("N/A") : encryption_name,
      prop_delim, kv_delim);
...
const std::string TablePropertiesNames::kEncryption = "rocksdb.encryption";
