...
void DumpManifestFile(Options options, std::string file, bool verbose, bool hex,
  ...
  VersionSet versions(dbname, immutable_db_options.env, &immutable_db_options, sopt, tc.get(), &wb, &wc,
...
Status ReduceDBLevelsCommand::GetOldNumOfLevels(Options& opt,
  ...
  VersionSet versions(db_path_, db_options.env, &db_options, soptions, tc.get(), &wb, &wc,
                      /*block_cache_tracer=*/nullptr);
